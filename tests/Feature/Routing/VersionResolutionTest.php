...
it('resolves v2 correctly', function () {
    $response = $this->api('v2', 'item', 'show', ['id' => 1], ['X-Auth-Token' => 'token']);
    $response->assertStatus(200);
    $data = $response->json();
...
it('v2 overrides v1 action with different response', function () {
    ...
    $v2Response = $this->api('v2', 'item', 'show', ['id' => 1], ['X-Auth-Token' => 'token']);
...
it('v2 adds new actions not in v1', function () {
    $response = $this->api('v2', 'item', 'search', ['query' => 'test'], ['X-Auth-Token' => 'token']);
    $response->assertStatus(200);
    $data = $response->json();
...
it('v2 disables inherited action', function () {
    ...
    $response = $this->api('v2', 'item', 'remove', [], ['X-Auth-Token' => 'token']);
    $data = $response->json();
